...
def config_mlflow():
    ...
    os.environ['MLFLOW_TRACKING_USERNAME'] = 'lauromello'
    os.environ['MLFLOW_TRACKING_PASSWORD'] = 'a685612158b8646e84f26a8b2961c77bce141f47'
    mlflow.set_tracking_uri('https://dagshub.com/lauromello/mlops-ead.mlflow')
